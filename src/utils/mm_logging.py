...
# Copied from https://mmengine.readthedocs.io/en/latest/_modules/mmengine/logging/logger.html
import inspect
import logging
import os
...
from utils.manager import _accquire_lock, _release_lock, ManagerMixin
...
class MMLogger(Logger, ManagerMixin):
    ...
    def __init__(self,
        ...
        global_rank = _get_rank() if distributed else 0
        device_id = _get_device_id() if distributed else 0
